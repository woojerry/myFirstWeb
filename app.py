...
def box_office():
    ...
    # 디버깅 시 -> chromedriver.exe 배포할 때는 -> /home/ubuntu/my_project/chromedriver
    ...
    # Windows Watcha ver.
#    crawl_from_watcha = soup.select(
#        '#root > div > div.css-1sh3zvx-NavContainer.ebsyszu0 > section > div > section > div:nth-child(1) >'
...
#        movie_name = infos.select_one(
#            'a > div.css-dmreg0-ContentInfo.e3fgkal2 > div.css-1teivyt-ContentTitle.e3fgkal3').text
...
# def get_Date():
#     date_from_button = request.form['date']
#     print(date_from_button)
#     return jsonify({'result': 'success', 'msg': 'POST 연결되었습니다!'})

# @app.route('/date', methods=['GET'])
# def read_DB():
#     movie_info = list(db.a)
#     return jsonify({'result': 'success', 'movie_infos': movie_info})
